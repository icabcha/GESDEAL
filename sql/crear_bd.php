...
<body>
    <?php
        ...
        ('PE-01', '2022-05-08', 'CL-01', 'EM-04'),
        ('PE-02', '2022-05-08', 'CL-02', 'EM-02'),
        ('PE-03', '2022-05-09', 'CL-01', 'EM-03')";
        ...
        ('PR-01', 'AR-01', '2022-05-02', 1.80, 51),
        ('PR-01', 'AR-04', '2022-05-12', 1.31, 100),
        ('PR-02', 'AR-14', '2022-05-20', 1.65, 30),
        ('PR-03', 'AR-13', '2022-05-11', 3.15, 24),
        ('PR-04', 'AR-08', '2022-03-08', 3.92, 18),
        ('PR-05', 'AR-03', '2022-05-02', 1.54, 60),
        ('PR-05', 'AR-07', '2022-05-26', 2.12, 22),
        ('PR-05', 'AR-16', '2022-05-26', 0.73, 15),
        ('PR-06', 'AR-09', '2022-05-16', 2.15, 25),
        ('PR-06', 'AR-15', '2022-04-21', 1.77, 15),
        ('PR-07', 'AR-12', '2022-05-23', 1.50, 45),
        ('PR-08', 'AR-06', '2022-04-27', 3.54, 40),
        ('PR-09', 'AR-02', '2022-05-03', 0.92, 40),
        ('PR-09', 'AR-11', '2022-03-07', 23.08, 15),
        ('PR-10', 'AR-05', '2022-04-19', 1.04, 100),
        ('PR-10', 'AR-10', '2022-03-25', 6.88, 16)";
